...
@Component(value="HMSPatientBusinessObject")
@Scope(value="prototype")
public class HMSPatientBusinesModel extends GenericBusinessModel implements java.io.Serializable, IHMSPatientBusinessModel {
